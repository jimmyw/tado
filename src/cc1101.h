/*
 * CC1101 Sub-1GHz RF Transceiver — Zephyr driver
 * Direct register-write approach (no high-level abstraction layer).
 *
...
/* low-level access (useful for debug register dumps) */
